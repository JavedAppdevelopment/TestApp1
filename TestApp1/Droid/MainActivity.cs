...
using TestApp1.Data;
using TestApp1.Forms;
using TestApp1.Forms.Droid;
using TestApp1.Forms.Droid.BroadcastReceiver;
using Xamarin.Forms;

namespace TestApp1.Droid
{
	[Activity(Label = "TestApp1.Droid", Icon = "@drawable/icon", Theme = "@style/MyTheme", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
